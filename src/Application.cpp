...
int main()
{
    ...
    unsigned char* data = stbi_load(RESOURCES_PATH "container2.png", &width, &height, &nrChannels, 0);
    ...
    else
    {
        ...
        // Remove the redeclaration of diffuseMap, just assign the result of loadTexture to the already-declared variable.
        diffuseMap = loadTexture(RESOURCES_PATH "container2.png");
    stbi_image_free(data);*/
    
    diffuseMap = loadTexture(RESOURCES_PATH "container2.png");
    specularMap = loadTexture(RESOURCES_PATH "container2_specular.png");


    Shader ourShader(RESOURCES_PATH "shader.vs", RESOURCES_PATH "textureshader.frag");
    Shader lightingShader(RESOURCES_PATH "shader.vs", RESOURCES_PATH "lightshader.frag");
    ...
    // Vertex attribute setup (fix for correct UV mapping)
